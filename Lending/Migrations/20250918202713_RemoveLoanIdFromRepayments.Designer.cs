...
namespace Lending.Migrations
{
    ...
    [Migration("20250918202713_RemoveLoanIdFromRepayments")]
    partial class RemoveLoanIdFromRepayments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lending.Models.LoanAdmin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Address = "Head Office",
                            CreatedAt = new DateTime(2025, 9, 18, 20, 27, 11, 468, DateTimeKind.Utc).AddTicks(6496),
                            IsActive = true,
                            PasswordHash = "$2a$11$zH0hRrm2/DuWqXeVvQBADOJrO1JChbq2..WsQbj/spSt3w4XtCCLK",
                            Role = 0,
